...
import { TransactionChargeRequestedEventPayloadFragment } from "../../../../generated/graphql";
 ...
 */
const TransactionChargeRequestedEventPayload = gql`
  fragment TransactionChargeRequestedEventPayload on TransactionChargeRequested {
    __typename
    issuingPrincipal {
      ... on Node {
        id
...
const TransactionChargeRequestedSubscription = gql`
  ...
  ${TransactionChargeRequestedEventPayload}
...
export const transactionChargeRequestedWebhook =
  new SaleorSyncWebhook<TransactionChargeRequestedEventPayloadFragment>({
